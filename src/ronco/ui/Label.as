package ronco.ui
{
	...
	public class Label extends UIElement
	{
		...
		public var ishandcur:Boolean = false;
		
		public var strike:Sprite = new Sprite;
...
//			label.filters = array;
		...
		//删除线
		public function setStrike(b:Boolean, w:int, c:uint = 0xff0000):void
		{
			strike.graphics.clear();
			strike.graphics.lineStyle(null, c);
			var x1:int = 0;
			if(label.autoSize == "left")
			{
				x1 = 0;
			}
			else if(label.autoSize == "center")
			...
			strike.graphics.moveTo(-1 + x1, lh / 2 - 3);
			strike.graphics.lineTo(x1 + w + 1, lh / 2 + 3);
			if(b)
