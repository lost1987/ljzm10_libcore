...
package ronco.ui.richtext
{
	...
	import ronco.ui.org.bytearray.gif.player.GIFPlayer;
...
//				$_htmlText = "";
		...
		public function clear():void
		{
			...
			{
				((_spriteContainer.getChildAt(0) as Sprite).getChildAt(0) as ronco.ui.org.bytearray.gif.player.GIFPlayer).dispose();
//				((_spriteContainer.getChildAt(0) as Sprite).getChildAt(0) as Bitmap).bitmapData = null;
...
//			var $_storeHeight:Number = _textField.height;
...
//						_textField.height = $_storeHeight;
//						trace("$_rect: width: " + $_rect.width + " height: " + $_rect.height + " x: " + $_rect.x + " y: " + $_rect.y);
						if ($_rect) {
...
//			trace("_spriteContainer.y: " + _spriteContainer.y);
		}
		//-------------------------------------------------------------------------
		// configXML
		//-------------------------------------------------------------------------
...
import ronco.ui.org.bytearray.gif.events.GIFPlayerEvent;
import ronco.ui.org.bytearray.gif.player.GIFPlayer;
...
internal class GifPlayer {
	...
	private function createClass($onComplete:Function = null):void
	{
		...
		var $_completeHandler:Function = function(evt:Event):void {
			_gifPlayerClass = ronco.ui.org.bytearray.gif.player.GIFPlayer;
			_gifPlayerEvent = ronco.ui.org.bytearray.gif.events.GIFPlayerEvent;
